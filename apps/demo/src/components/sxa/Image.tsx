...
const ImageDefault = (): JSX.Element => (
...
export const Banner = (props: ImageProps): JSX.Element => {
  ...
  return (
    <div
      className={cn('component hero-banner', {
        [`${classHeroBannerEmpty}`]: classHeroBannerEmpty,
...
export const Default = (props: ImageProps): JSX.Element => {
  ...
  if (props.fields) {
    ...
    return (
      <div
        className={cn('component image', { [`${props?.params?.styles}`]: props?.params?.styles })}
        id={id ? id : undefined}
      >
        <div className="component-content">
