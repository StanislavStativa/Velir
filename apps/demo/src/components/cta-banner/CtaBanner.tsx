...
const ctaTitleVariants = cva(
  'mb-6 text-pretty text-4xl font-normal leading-[1.1333] tracking-tighter md:text-7xl',
  {
    variants: {
      colorScheme: {
        default: '',
      ...
      <section className={ctaBannerVariants({ colorScheme })}>
        <div className="mx-auto w-full max-w-4xl">
          ...
          <AnimatedSection direction="up" isPageEditing={isPageEditing}>
            ...
            <Text tag="p" className="mx-auto mb-16 max-w-xl text-lg" field={descriptionOptional} />
